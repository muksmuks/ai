...
> Analyst can be Data Scientist or Business Analyst. Data Scientists took pro-code approach why business analyst would rely
> on no-code or low-code tools like Tableau etc

The journey from data to insight would begin by an analyst
