...
samples of reality and then draws conclusions. For example, “The coin I pulled from the bag is a penny.
The second and the third coins from the bag are pennies. Therefore, all the coins in the bag are pennies.”
Note that even if all the premises are true in the original statement, inductive reasoning can lead to false conclusions.
Here’s an example: “Harold is a grandfather. Harold is bald. Therefore, all grandfathers are bald.”
In this case, the conclusion does not follow logically from the statements.
...
In the next article we will cover how to introduce tools from AI repertoire which can help us design a system which is more intelligent
and eases the journey from "Data to Insight"

### References
[1] Ackoff, R. L. (1989). From data to wisdom. Journal of applied systems analysis, 16(1), 3-9.
[2] (2000). CRISP-DM 1.0 – Step-by-step data mining guide. SPSS Inc.