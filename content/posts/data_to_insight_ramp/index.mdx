...
[Reasoning model](https://ai.mukeshkr.me/reasoners/) take it a step forward by providing an ability to reason and plan for an ask at inference time. They demonstrate generating very long reasoning
